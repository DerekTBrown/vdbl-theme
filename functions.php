...
add_action('init', function(){
    ...
    $labels = array(
        'name'                  => __( 'Brothers',                      ZEETEXTDOMAIN ),
        'singular_name'         => __( 'Brothers',                      ZEETEXTDOMAIN ),
        'menu_name'             => __( 'Brothers',                      ZEETEXTDOMAIN ),
        'all_items'             => __( 'Brothers',              ZEETEXTDOMAIN ),
        'add_new'               => __( 'Add New',                   ZEETEXTDOMAIN ),
        'add_new_item'          => __( 'Add New Brother',            ZEETEXTDOMAIN ),
        'edit_item'             => __( 'Edit Brother',               ZEETEXTDOMAIN ),
        'new_item'              => __( 'New Brother',                ZEETEXTDOMAIN ),
        'view_item'             => __( 'View Brother',               ZEETEXTDOMAIN ),
        'search_items'          => __( 'Search Brothers',             ZEETEXTDOMAIN ),
        'not_found'             => __( 'No Brothers found',           ZEETEXTDOMAIN ),
        'not_found_in_trash'    => __( 'No Brother found in Trash',  ZEETEXTDOMAIN )
        );
...
$fields = array(
    ...
    array(
        'label' => __('Major',                    ZEETEXTDOMAIN),
        'id'    => $prefix.'major',
        'type'  => 'text'
        ),

    array(
        'label' => __('Class',                       ZEETEXTDOMAIN),
        'id'    => $prefix.'class',
        'type'  => 'text'
        )
    );
...
add_action('init', function(){
    ...
    $labels = array(
        ...
        'menu_name'             => __( 'Virtues',                  ZEETEXTDOMAIN ),
