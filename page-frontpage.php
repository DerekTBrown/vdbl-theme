...
<!--
    ...
    <section class="sigep-follow">
      <div class="sigep-follow-inner">
        <div class="row">
          <center><h2>Follow Us</h2></center>
        </div>
        <div class="row" style="margin-bottom:40px;">
          <a class="sigep-social-button" href="https://www.facebook.com/SigEpPennTheta">
            <i class="icon-facebook"></i>
          </a>
          <a class="sigep-social-button" href="https://twitter.com/sigep_penntheta">
        ...
        <iframe src="http://snapwidget.com/sc/?u=c2lnZXBfY211fGlufDE1MHwzfDN8fG5vfDV8bm9uZXxvblN0YXJ0fHllc3xubw==&ve=051115" title="Instagram Widget" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:1200px; height:150px"></iframe>
      </div>
    </section>
    <?php
    get_footer();
