...
add_shortcode( 'zee_service', function( $atts, $content= null ){
  ...
  if(  $category > 0 ){
    ...
    <div class="row" style="margin-bottom:30px;">
      <center><h1>Building Balanced Men since 1925.</h1></center>
    </div>
    <div class="row">
...
add_shortcode( 'sigep_bros', function( $atts, $content = null ){
  ...
  <div class="team row">
    ...
    <a class="btn btn-primary" href="http://sigep.allderek.com/brother/" >Read More</a>
    </div>

    <?php foreach ($data as $key => $value) {
      $thumb_id = wp_get_attachment_image_src( get_post_thumbnail_id($value->ID), 'thumbnail' );
      $thumb_url = $thumb_id['0'];

    ?>
    <a href="<?php echo get_permalink($value->ID);?>" class="brother" />
      <div  class="col-md-3 col-sm-4 col-xs-6">
        <div class="center team-member">
          <p><img class="img-circle img-thumbnail" src="<?php echo $thumb_url; ?>" alt="<?php echo $value->post_title; ?>"></p>
          <h3><?php echo $value->post_title; ?>
            <?php if(get_post_meta($value->ID, 'sigep_major', true)!=''){ ?>
            <br><small class="designation muted"><?php echo get_post_meta($value->ID, 'sigep_major', true)   ?></small>
            <?php } ?>
            <?php if(get_post_meta($value->ID, 'sigep_class', true)!=''){ ?>
            <br><small class="designation muted"><?php echo get_post_meta($value->ID, 'sigep_class', true)   ?></small>
            <?php } ?>
          </h4>
